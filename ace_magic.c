...
#define BmagicNOMASK2(sq, occ) *(bishop_indices2[sq] + (((occ) * bishop_magics[sq]) >> bishop_shift[sq]))
#define RmagicNOMASK2(sq, occ) *(rook_indices2[sq] + (((occ) * rook_magics[sq]) >> rook_shift[sq]))
